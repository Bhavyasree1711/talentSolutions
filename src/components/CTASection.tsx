...
export default function CTASection({
  ...
  subtitle = "Partner with DMX Talent Solutions and discover how we can transform your hiring process and connect you with exceptional talent.",
    ...
    <section id="cta" className="py-20 lg:py-28 relative overflow-hidden" style={{ background: 'linear-gradient(to right, #C53030 0%, #0f1d33 100%)' }}>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <ScrollReveal direction="up">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight whitespace-pre-line" style={{ fontFamily: 'var(--font-outfit)' }}>
            {title}
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href={buttonHref} className="px-8 py-4 bg-[#8C1D1D] hover:bg-[#7A1515] text-white font-bold text-sm rounded-lg transition-all duration-300 hover:shadow-xl tracking-wide uppercase inline-flex items-center gap-2 group">
              {buttonText}
