        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2">
            ...
            <p className="text-lg leading-relaxed mb-6">
              Learn modern DevOps practices including CI/CD, automation, containers,
              and deployment pipelines using Microsoft Azure DevOps tools.
            </p>
          ...
          <div className="md:w-1/2 relative h-64">
            <Image
              src="/images/azuredevops.png"
              alt="Azure DevOps Training"
              fill
