...
export default function MachineLearningPage() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen pb-20">
      ...
      <section className="bg-gradient-to-r from-green-700 to-emerald-500 text-white py-16">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2">
            <h1 className="text-5xl font-bold mb-4">Machine Learning Training</h1>
            <p className="text-lg mb-6">
              Learn ML algorithms, model building, evaluation, and deployment using real datasets.
            </p>
          ...
          <div className="md:w-1/2 relative h-64">
            <Image src="/images/ml.jpg" alt="ML Training" fill className="object-contain" />
          </div>
        </div>
      </section>
