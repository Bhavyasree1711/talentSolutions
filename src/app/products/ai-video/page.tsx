          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {[
                ...
                <div key={i} className={`bg-white p-6 rounded-2xl shadow-md border border-gray-100 border-l-4 ${feature.borderColor} hover:shadow-lg transition-shadow flex flex-col items-start gap-4`}>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={i} className="bg-white rounded-3xl border border-gray-100 border-l-4 border-l-red-500 shadow-lg overflow-hidden flex flex-col h-full hover:shadow-xl transition-shadow">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div key={i} className={`bg-white p-8 rounded-2xl shadow-sm flex flex-col items-start gap-4 hover:shadow-md transition-shadow border border-gray-100 border-l-4 ${card.borderColor}`}>
